...
do 
	echo "Uploading $f"; 
	curl -X PUT -T $f -u chiju:32ea322465698d89b0b2844be7d8007527516e6e -H "X-Bintray-Version:$version" -H "X-Bintray-Package:openssh"  https://api.bintray.com/content/chiju/debs/openssh/$version/$f; 
done